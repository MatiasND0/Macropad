...
void loop(){
  ...
  if(Serial.available()>0){
    ...
    if(incomingByte==48) profile=0;
    if(incomingByte==49) profile=1;
    if(incomingByte==50) profile=2;  
    if(incomingByte==51) profile=3;
    if(incomingByte==52) profile=4;
    if(incomingByte==53) profile=5;
  }
  
  while(digitalRead(button_1)==0 || digitalRead(button_2)==0 || digitalRead(button_3)==0 || digitalRead(button_4)==0 || digitalRead(button_5)==0 || digitalRead(button_6)==0 || digitalRead(button_encoder)==0 ){
    if(digitalRead(button_1)==0) keyset(1,0); else keyset(1,1);
    if(digitalRead(button_2)==0) keyset(2,0); else keyset(2,1);
    if(digitalRead(button_3)==0) keyset(3,0); else keyset(3,1);
    if(digitalRead(button_4)==0) keyset(4,0); else keyset(4,1);
    if(digitalRead(button_5)==0) keyset(5,0); else keyset(5,1);
    if(digitalRead(button_6)==0) keyset(6,0); else keyset(6,1);
...
void keyset(int num,bool por){
  switch(profile){
    case 0:
      switch(num){
        case 1:
          if (por==0) Keyboard.press(KEYPAD_1); else Keyboard.release(KEYPAD_1);
          break;
        case 2:
          if (por==0) Keyboard.press(KEYPAD_2); else Keyboard.release(KEYPAD_2);
          break;
        case 3:
          if (por==0) Keyboard.press(KEYPAD_3); else Keyboard.release(KEYPAD_3);
          break;
        case 4:
          if (por==0) Keyboard.press(KEYPAD_4); else Keyboard.release(KEYPAD_4);
          break;
        case 5:
          if (por==0) Keyboard.press(KEYPAD_5); else Keyboard.release(KEYPAD_5);
          break;
        case 6:
          if (por==0) Keyboard.press(KEYPAD_6); else Keyboard.release(KEYPAD_6);
          break;
      }
      break;
    case 1:
      switch(num){
        case 1:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_3);delay(100);}
          break;
        case 2:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_4);delay(100);}
          break;
        case 3:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_5);delay(100);}
          break;
        case 4:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_6);delay(100);}
          break;
        case 5:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_7);delay(100);}
          break;
        case 6:
          if (por==0){Keyboard.write(KEY_LEFT_ALT);delay(50);Keyboard.write(KEY_8);delay(100);}
          break;
      }
      break;
    case 2:
      switch(num){
          case 1:
            if (por==0) {Keyboard.press(KEY_LEFT_WINDOWS);delay(25);Keyboard.write(KEY_D);Keyboard.releaseAll();delay(100);}
            break;
          case 2:
            if (por==0) Keyboard.press(KEYPAD_6); else Keyboard.release(KEYPAD_6);
            break;
          case 3:
            ...
            break;
          case 4:
            if (por==0) {Consumer.press(MEDIA_PLAY_PAUSE);delay(100);}
            break;
          case 5:
            if (por==0) Keyboard.press(KEYPAD_6); else Keyboard.release(KEYPAD_6);
            break;
